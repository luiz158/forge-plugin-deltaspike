 ...
 * TODO Need to clean this up for the real usages.
 */
public final class Utils {
    ...
    public static Method getMethodFromDescriptor(String descriptor, ClassLoader... classLoaders) throws
            JavaMetaDataException {
...
//                return aClass.getConstructor(parameterTypes);
            ...
            throw new JavaMetaDataException("Can't resolve method named " + methodName, e);
        }
    }
    ...
    public static Field getFieldFromString(String field, ClassLoader... classLoaders) {
        ...
        try {
            ...
            throw new JavaMetaDataException("Can't resolve field named " + fieldName, e);
        }
    }
